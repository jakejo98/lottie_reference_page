document.addEventListener("DOMContentLoaded", function(){
    ...
    var loading_bar = bodymovin.loadAnimation({
      ...
      var multiple_arrows = bodymovin.loadAnimation({
        container: document.getElementById('multiple_arrows'), // 필수, 애니메이션 들어가는 곳 
        path: './json/multiple_arrows.json', // 필수(url 또는 json파일 다운로드 경로)
        renderer: 'svg', // 필수
        loop: true, // 반복재생
        autoplay: true, // 자동재생
        name: "Hello World", // 이름 지정, 필수 아님
